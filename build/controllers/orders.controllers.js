...
exports.deleteAddProduct = exports.getOne = exports.addProduct = exports.createOrder = void 0;
...
var addProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderModel.addProduct(req.body)];
            case 1:
                product = _a.sent();
                res.json({
                    status: 'done',
            ...
            case 1:
                ...
                if (!order) {
                    return [2 /*return*/, res.json({
                            status: 'GET error',
                            message: "No order with ID:".concat(id),
                        })];
                }
                res.json({
                    status: 'done',
...
var deleteAddProduct = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, user, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, orderModel.deleteAddProduct(id)];
            case 1:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, res.json({
                            status: 'DELETE error',
                            message: "Ordered Product with ID:".concat(id, " does't exist"),
                        })];
                }
                else {
                    res.json({
...
exports.deleteAddProduct = deleteAddProduct;
